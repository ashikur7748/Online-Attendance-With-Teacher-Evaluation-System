...
?>
    ...
    <form class="row g-3" method="post" action="profile_action.php">

      <input type="hidden" name="id" value="<?php echo $id; ?>">
<div class="col-md-6">
  <label for="inputEmail4" class="form-label"><?php echo $role; ?> Name <span style="color: red;">*</span></label>
...
<div class="col-md-6">
  <label for="inputEmail4" class="form-label">Username/<?php echo $role; ?> ID <span style="color: red;">*</span></label>
  <input type="text" class="form-control" id="inputID" name="username" disabled="" value="<?php echo $username; ?>">
</div>
  ...
  <div class="col-md-6">
    ...
    <select id="inputState" class="form-control" name="department" disabled="">
      <option value="<?php echo $department; ?>" disable><?php echo $department; ?></option>
  ...
  <div class="col-md-6">
    ...
    <input type="date" class="form-control" id="inputDOB" name="dob" value="<?php echo $dateofbirth; ?>" disabled="">
  </div>
...
if($gender=="Male"){
  echo"<div class='col-12'>
    ...
    <div class='form-check'>
      <input class='form-check-input' type='radio' value='Male' id='gridCheck' name='gender' checked disabled>
    ...
    <div class='col-12'>
    <div class='form-check'>
      <input class='form-check-input' type='radio' value='Female' id='gridCheck' name='gender' disabled>
      <label class='form-check-label' for='gridCheck'>
        Female
      </label>
    </div>
 ...
 echo"<div class='col-12'>
    ...
    <label class='form-label'>Gender </label>
    <div class='form-check'>
      <input class='form-check-input' type='radio' value='Male' id='gridCheck' name='gender'  disabled>
      <label class='form-check-label' for='gridCheck'>
        Male
      </label>
    </div>
    ...
    <div class='col-12'>
    <div class='form-check'>
      <input class='form-check-input' type='radio' value='Female' id='gridCheck' name='gender' checked disabled>
      <label class='form-check-label' for='gridCheck'>
        Female
      </label>
    </div>
