                        ...
                        <div class="row">
                             <div class="col-11" style="margin: auto;">
                              ...
                              <hr style="margin-bottom: 30px;">
                                                            ...
                                                            <form class="row g-3" method="post" action="add_student_action.php">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <label for="inputEmail4" class="form-label">Username/Student ID <span style="color: red;">*</span></label>
                              ...
                              <div class="col-md-6">
                                ...
                                <select id="inputState" class="form-control" name="department">
                                  <option value="CSE" selected>CSE</option>
                                      ...
                                      <option value="CIVILL">CIVILL</option>
                                </select>
                              </div>
                              ...
                              <?php 
                                        if(isset($_GET['msg']))
                                          {
                                            $msgshow = $_GET['msg'];
                                            if($msgshow=="Student Add Successfully."){
