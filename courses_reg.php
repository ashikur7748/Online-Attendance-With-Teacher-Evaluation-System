                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                             <div class="col-12" style="margin: auto;">
                              <br>
                              <h3 class="mt-4">Courses Registration</h3>
                              <hr style="margin-bottom: 30px;">

                                <form class="row g-3" method="post" action="courses_reg_action.php">
                                <div class="col-md-6">
                                  <label for="inputEmail4" class="form-label">Student Name <span style="color: red;">*</span></label>
                                  

                                  <select id="inputname" class="form-control" name="  student_id">
         <?php
