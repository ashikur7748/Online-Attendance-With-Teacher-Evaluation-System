...
if($query)
{
	header("location:add_student.php?msg=Student Add Successfully.");
}
else
{
	header("location:add_student.php?msg=Data Add Not Successfull.Please Check.");
}
...
{
	header("location:add_student.php?msg=Enter Fields");
}
